...
urlpatterns = [
    ...
    path('cart/', cart_detail, name='cart-detail-url'),
    path('cart-add/<product_slug>/', cart_add, name='cart-add-url'),
    path('cart-remove/<product_slug>/', cart_remove, name='cart-remove-url'),
